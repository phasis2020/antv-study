;(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined'
		? factory(exports, require('@antv/l7'))
		: typeof define === 'function' && define.amd
		? define(['exports', '@antv/l7'], factory)
		: ((global = global || self),
		  factory(
				((global.L7 = global.L7 || {}), (global.L7.District = {})),
				global.L7
		  ))
})(this, function (exports, l7) {
	'use strict'
	...
	function writeFeature(feature, pbf) {
		...
		if (feature.id !== undefined) {
			if (typeof feature.id === 'number' && feature.id % 1 === 0)
				pbf.writeSVarintField(12, feature.id)
	...
	function readProps(pbf, props) {
		var end = pbf.readVarint() + pbf.pos
		while (pbf.pos < end)
			props[keys$1[pbf.readVarint()]] = values[pbf.readVarint()]
		values = []
		return props
	}
	 ...
	 * // => { 'a': [1, 3], 'b': [2, 4] }
	 */
	var mergeWith = _createAssigner(function (
		object,
		source,
		srcIndex,
		customizer
	...
	var simplifyGeometry = function (points, tolerance) {
		...
		if (dmax > tolerance) {
			...
			var results_two = simplifyGeometry(
		...
		function simplifyFeature(feat, tolerance) {
			...
			if (type === 'LineString') {
				...
				for (var j = 0; j < geom.coordinates.length; j++) {
					geom.coordinates[j] = module.exports.simplify(
						geom.coordinates[j],
						tolerance
					)
				}
				...
				for (var k = 0; k < geom.coordinates.length; k++) {
					for (var l = 0; l < geom.coordinates[k].length; l++) {
						geom.coordinates[k][l] = module.exports.simplify(
							geom.coordinates[k][l],
							tolerance
						)
					}
				}
	...
	var BaseLayer = /*#__PURE__*/ (function (_EventEmitter) {
		...
		function BaseLayer(scene) {
			...
			_this.layers = []
			_this.scene = scene
			_this.options = mergeWith_1(
				_this.getDefaultOption(),
				option,
				mergeCustomizer
			)
			...
			},
			{
				...
				value: function on(event, handle) {
					...
					if (eventList.indexOf(event) !== -1) {
						_get(_getPrototypeOf(BaseLayer.prototype), 'on', this).call(
							this,
							event,
							handle
						)
						...
						if (this.loaded && this.getLayer(layerType)) {
							...
							_get(_getPrototypeOf(BaseLayer.prototype), 'once', this).call(
								this,
								'loaded',
								function () {
				...
				value: function addFillLayer(fillCountry) {
					...
					if (this.options.onClick) {
						this.fillLayer.on('click', function (e) {
							_this5.options &&
								_this5.options.onClick &&
								_this5.options.onClick(e, _this5.layerType)
						})
					}

					if (
						this.options.bubble &&
						((_this$options$bubble = this.options.bubble) === null ||
						_this$options$bubble === void 0
							? void 0
							: _this$options$bubble.enable) !== false
					) {
						var labeldata = fillCountry.features.map(function (feature) {
							return _objectSpread2(
								_objectSpread2({}, feature.properties),
								{},
								{
			...
			},
			{
				...
				value: function addPopup() {
					...
					popupLayer.on(popup.openTriggerEvent, function (e) {
						var html = popup.Html
							? popup.Html(
									e.feature.properties ? e.feature.properties : e.feature
							  )
							: ''
						_this6.popup = new l7.Popup(
							_objectSpread2(
								{
									closeButton: false,
								},
	...
	var ProvinceLayer = /*#__PURE__*/ (function (_BaseLayer) {
		...
		_createClass(ProvinceLayer, [
			...
			},
			{
				...
				value: function getDefaultOption() {
					var config = _get(
						_getPrototypeOf(ProvinceLayer.prototype),
						'getDefaultOption',
						this
					).call(this)
			...
			},
			{
				...
				value: (function () {
					var _addProvinceFillLayer = _asyncToGenerator(
										...
										switch ((_context.prev = _context.next)) {
											case 0:
												;(_this$options2 = this.options),
													...
													(adcode = _this$options2.adcode),
													(label = _this$options2.label),
													(showBorder = _this$options2.showBorder)
												countryConfig = getDataConfig(this.options.geoDataLevel)
													.country.CHN[depth]
												_context.next = 4
											...
											case 4:
												...
												this.labelRawData = fillData.features.map(function (
													feature
												) {
													return _objectSpread2(
														_objectSpread2({}, feature.properties),
			...
			},
			{
				...
				value: (function () {
					var _addProvinceLineLayer = _asyncToGenerator(
										...
										switch ((_context2.prev = _context2.next)) {
											case 0:
												;(_this$options3 = this.options),
													(depth = _this$options3.depth),
													(adcode = _this$options3.adcode)
												countryConfig = getDataConfig(this.options.geoDataLevel)
													.country.CHN[depth]
												_context2.next = 4
		...
		_createClass(CityLayer, [
			{
				...
				value: function getDefaultOption() {
					var config = _get(
						_getPrototypeOf(CityLayer.prototype),
						'getDefaultOption',
						this
					).call(this)
	...
	var CountryLayer = /*#__PURE__*/ (function (_BaseLayer) {
		...
		_createClass(CountryLayer, [
			...
			},
			{
				key: 'addProvinceFill',
				value: (function () {
					var _addProvinceFill = _asyncToGenerator(
						/*#__PURE__*/ regeneratorRuntime.mark(function _callee2() {
									...
									while (1) {
										switch ((_context2.prev = _context2.next)) {
											case 0:
												;(_this$options2 = this.options),
													(depth = _this$options2.depth),
													(adcode = _this$options2.adcode) // 根据depth 获取数据
			...
			},
			{
				...
				value: (function () {
					var _addProvinceLabel = _asyncToGenerator(
									...
									while (1) {
										switch ((_context3.prev = _context3.next)) {
											...
											case 9:
												...
												if (
													fillLabel &&
													((_this$options$label = this.options.label) ===
														null || _this$options$label === void 0
														? void 0
														: _this$options$label.enable)
												) {
													this.addLabelLayer(
														fillLabel.filter(function (v) {
															return v.name !== '澳门'
														})
													)
													this.addMCLabel()
			...
			},
			{
				key: 'addProvinceLine',
				value: (function () {
					var _addProvinceLine = _asyncToGenerator(
						/*#__PURE__*/ regeneratorRuntime.mark(function _callee4(cfg) {
							var lineData,
								border1,
								border2,
								borderFc,
									...
									while (1) {
										switch ((_context4.prev = _context4.next)) {
											...
											case 2:
												...
												nationalBorder = lineData.features.filter(function (
													feature
												) {
													var type = feature.properties.type
			...
			},
			{
				...
				value: (function () {
					var _addNormalProvinceLine = _asyncToGenerator(
						/*#__PURE__*/ regeneratorRuntime.mark(function _callee5(cfg) {
			...
			},
			{
				key: 'addNationBorder',
				value: (function () {
					var _addNationBorder = _asyncToGenerator(
								...
								function _callee7$(_context7) {
									while (1) {
										switch ((_context7.prev = _context7.next)) {
											case 0:
												;(_this$options3 = this.options),
													(nationalStroke = _this$options3.nationalStroke),
													(provinceStroke = _this$options3.provinceStroke),
													(provinceStrokeWidth =
														_this$options3.provinceStrokeWidth),
													(nationalWidth = _this$options3.nationalWidth),
													(chinaNationalStroke =
														_this$options3.chinaNationalStroke),
													(chinaNationalWidth =
														_this$options3.chinaNationalWidth),
													(coastlineStroke = _this$options3.coastlineStroke),
													(coastlineWidth = _this$options3.coastlineWidth),
													(showBorder = _this$options3.showBorder),
													(stroke = _this$options3.stroke),
													(strokeWidth = _this$options3.strokeWidth),
													(visible = _this$options3.visible),
													(zIndex = _this$options3.zIndex),
													(strokeOpacity = _this$options3.strokeOpacity) // 添加国界线
			...
			},
			{
				key: 'addCityBorder',
				value: (function () {
					var _addCityBorder = _asyncToGenerator(
						/*#__PURE__*/ regeneratorRuntime.mark(function _callee8(cfg) {
							var border1,
								_this$options4,
								cityStroke,
								cityStrokeWidth,
										...
										switch ((_context8.prev = _context8.next)) {
											...
											case 2:
												...
												;(_this$options4 = this.options),
													(cityStroke = _this$options4.cityStroke),
													(cityStrokeWidth = _this$options4.cityStrokeWidth),
													(visible = _this$options4.visible),
													(strokeOpacity = _this$options4.strokeOpacity)
			...
			},
			{
				key: 'addCountyBorder',
				value: (function () {
					var _addCountyBorder = _asyncToGenerator(
						/*#__PURE__*/ regeneratorRuntime.mark(function _callee9(cfg) {
							var border1,
								_this$options5,
								countyStrokeWidth,
								countyStroke,
										...
										switch ((_context9.prev = _context9.next)) {
											...
											case 2:
												...
												;(_this$options5 = this.options),
													(countyStrokeWidth =
														_this$options5.countyStrokeWidth),
													(countyStroke = _this$options5.countyStroke),
													(visible = _this$options5.visible),
													(strokeOpacity = _this$options5.strokeOpacity)
												cityline = new l7.LineLayer({
													zIndex: 2,
													visible: visible,
												})
				...
				value: function addCountryEvent() {
					...
					this.provinceLayer.fillLayer.on(drillDownTriggerEvent, function (e) {
						...
						if (_this.drillList.indexOf(type) !== -1) {
							...
							drillDownEvent &&
								drillDownEvent(e.feature.properties, type, adcode)
						}
					})
				}, // 大区下钻
			},
			{
				...
				value: function addRegionEvent() {
					...
					this.regionLayer.fillLayer.on(drillUpTriggerEvent, function (e) {
						...
						if (_this2.drillList.indexOf('Country') !== -1)
							drillUpEvent &&
								drillUpEvent({
									from: 'region',
									to: 'country',
			...
			},
			{
				...
				value: function addProvinceEvent() {
					...
					this.cityLayer.fillLayer.on(drillUpTriggerEvent, function () {
						...
						if (_this3.drillList.indexOf(next) !== -1)
							drillUpEvent &&
								drillUpEvent({
									to: next,
									from: 'Province',
			...
			},
			{
				...
				value: function addCityEvent() {
					...
					this.countyLayer.fillLayer.on(drillUpTriggerEvent, function () {
						...
						if (_this4.drillList.indexOf('Province') !== -1)
							drillUpEvent &&
								drillUpEvent({
									to: 'Province',
									from: 'city',
			...
			},
			{
				...
				value: function showCityView(code, newData, joinByField) {
					...
					if (adcode.substr(2, 2) === '00') {
						// 重庆包含两个编码
						adcode = [
							adcode.substr(0, 2) + '0100',
							adcode.substr(0, 2) + '0200',
						]
					} // 更新县级行政区划
				...
				value: function initLayers(scene) {
					...
					viewList.indexOf('Country') !== -1 &&
						(this.provinceLayer = new CountryLayer(
							scene,
							_objectSpread2({}, this.getLayerOption('Province'))
						))
					...
					viewList.indexOf('Province') !== -1 &&
						(this.cityLayer = new ProvinceLayer(
							scene,
							this.getLayerOption('City')
						))
					viewList.indexOf('City') !== -1 &&
						(this.countyLayer = new CityLayer(
							scene,
							this.getLayerOption('County')
						))
				},
			},
			{
					...
					if (!this.options.customTrigger) {
						viewList.indexOf('Country') !== -1 &&
							this.provinceLayer.on('loaded', function () {
								...
								if (_this5.options.viewStart !== 'Country')
									_this5.provinceLayer.hide()

								_this5.layers.push(_this5.provinceLayer)
							})
						viewList.indexOf('Region') !== -1 &&
							this.regionLayer.on('loaded', function () {
								// 支持大区 或者省份下钻
								_this5.addRegionEvent()

								if (_this5.options.viewStart !== 'Region')
									_this5.regionLayer.hide()
						...
						viewList.indexOf('Province') !== -1 &&
							this.cityLayer.on('loaded', function () {
								...
								if (_this5.options.viewStart !== 'Province')
									_this5.cityLayer.hide()
						...
						viewList.indexOf('City') !== -1 &&
							this.countyLayer.on('loaded', function () {
								...
								if (_this5.options.viewStart !== 'City')
									_this5.countyLayer.hide()
	...
	var WorldLayer = /*#__PURE__*/ (function (_BaseLayer) {
		...
		function WorldLayer(scene) {
			...
			_this.loadData().then(function (_ref) {
				...
				if (
					(_this$options$label = _this.options.label) === null ||
					_this$options$label === void 0
						? void 0
						: _this$options$label.enable
				) {
	...
	console.log(Object.defineProperty(exports, '__esModule', { value: true }))
})
// console.log(L7)
// console.log(L7.District)
